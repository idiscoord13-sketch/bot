...
class Telegram
{
     ...
     */
    public function __construct($bot_id, $security = true)
    {
        $this->bot_id = $bot_id;
    ...
    /**
     * @return \library\TelegramBot
     */
    public function telegram()
    {
        if ( !class_exists( 'TelegramNS/TelegramBot' ) )
        {
            require_once CLASS_DIR . '/TelegramBot.php';
        }
        return new \TelegramNS\TelegramBot();
    }
    ...
    {
        $replyMarkup = array('hide_keyboard' => true, 'selective' => $selective);
        $encodedMarkup = json_encode($replyMarkup, true);
        return $encodedMarkup;
    }
    ...
    {
        $replyMarkup = array('force_reply' => true, 'selective' => $selective);
        $encodedMarkup = json_encode($replyMarkup, true);
        return $encodedMarkup;
    }
