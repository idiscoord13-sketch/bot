...
// mine
define(
    "KEY_INVITE_MENU", $telegram->buildKeyBoard([
    [
        $telegram->buildKeyboardButton('📤 لینک دعوت من'),
        $telegram->buildKeyboardButton('📊 آمار دعوت‌ها')
    ],
    [
        $telegram->buildKeyboardButton('🏆 برندگان'),
        $telegram->buildKeyboardButton('🎁 جوایز')
    ],
    [
        $telegram->buildKeyboardButton('♨️ بازگشت به منوی اصلی')
    ]
